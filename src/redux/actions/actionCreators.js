import {USER_SIGNUP_START, USER_SIGNUP_FINISH, 
    ...
    USER_CHECK_LOGIN_STATUS_FINISH, USER_SEND_VERIFICATION_MAIL_START, USER_READ_ALL_SUBORDINATE_FINISH,
    USER_SEND_VERIFICATION_MAIL_FINSIH, USER_READ_QUERY_FINISH, USER_READ_QUERY_START,
    ADMIN_READ_ALL_STORIES_FINISH, ADMIN_READ_ALL_STORIES_START, ADMIN_READ_ALL_TEAMS_FINISH, ADMIN_READ_ALL_TEAMS_START,
    USER_READ_ALL_SUBORDINATE_START } from './actions'
...
export function userReadAllSubordinateFinish(subordinates){
    return {
        type : USER_READ_ALL_SUBORDINATE_FINISH,
